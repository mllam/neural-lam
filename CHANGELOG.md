...
- Add comprehensive type hints to ARForecaster in `neural_lam/models/forecasters/autoregressive.py` [\#662](https://github.com/mllam/neural-lam/issues/662) @GiGiKoneti
