...
- Cache the mdp example input data in CI with fsspec `simplecache`, so the DANRA inputs are no longer downloaded on every run [\#257](https://github.com/mllam/neural-lam/issues/257) @KumarShivam1908
