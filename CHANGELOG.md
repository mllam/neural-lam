...
- Avoid NaN mesh features when graph creation receives a degenerate grid whose
  maximum coordinate is zero ([#594](https://github.com/mllam/neural-lam/issues/594))
  @pragnyanramtha
