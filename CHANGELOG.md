...
- Fix Sphinx build warnings by standardizing NumPy-style docstrings, correcting literal block indentations, and suppressing non-actionable duplication warnings in Sphinx configuration.
