...
- Add comprehensive type hints to StepPredictor in `neural_lam/models/step_predictors/base.py` [\#664](https://github.com/mllam/neural-lam/issues/664) @GiGiKoneti
