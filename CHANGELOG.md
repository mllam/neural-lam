...
- Fixed unscaled `pred_std` when `output_std=True` in `BaseGraphModel` which caused exponential loss blowup during probabilistic model training [\#347](https://github.com/mllam/neural-lam/issues/347)
