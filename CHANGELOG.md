...
- Fix `get_integer_time` to handle zero timedelta correctly and avoid floating-point precision issues [#469](https://github.com/mllam/neural-lam/pull/469) @Saptami191
