...
- Prevent `plot_error_map` from crashing with division by zero `NaN` values when a state variable has exactly zero error [\#334](https://github.com/mllam/neural-lam/issues/334) @AftAb-25
