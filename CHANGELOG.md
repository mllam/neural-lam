...
- Fix plotting bounds calculation (`var_vmin` / `var_vmax`) to support multidimensional DataArrays by using `flatten(0, -2)` [\#520](https://github.com/mllam/neural-lam/issues/520) @Debadri-das
