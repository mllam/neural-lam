...
def create_graph(
    ...
    * d_features: number of features per edge (currently d_features==3, for
      edge-length, x and y)
    * N_g2m_edges: number of edges in the graph from grid-to-mesh
    * N_m2g_edges: number of edges in the graph from mesh-to-grid
    * N_m2m_edges_level: number of edges in the graph from mesh-to-mesh
      at a given level (list index corresponds to the level)
    * d_mesh_static: number of static features per mesh node (currently
    ...
    * N_mesh_nodes_level: number of nodes in the mesh at a given level
    ...
    - mesh_up_edge_index.pt: list of [2, N_mesh_updown_edges_level],
      length==n_levels-1
    - mesh_up_features.pt: list of [N_mesh_updown_edges_level, d_features],
      length==n_levels-1
    - mesh_down_edge_index.pt: list of [2, N_mesh_updown_edges_level],
      length==n_levels-1
    - mesh_down_features.pt: list of [N_mesh_updown_edges_level, d_features],
      length==n_levels-1
