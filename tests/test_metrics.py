...
class TestSpreadSquared:
    ...
    def test_known_value_two_members(self):
        ...
        """
        # Shape: (B=1, S=2, N=1, d_state=1) — T folded into B per (...) convention
    ...
    def test_known_value_three_members(self):
        ...
        """
        # Shape: (B=1, S=3, N=1, d_state=1) — T folded into B per (...) convention
    ...
    def test_unbiased_estimation_large_ensemble(self):
        ...
        S = 10000
        # Shape: (B=1, S=10000, N=1, d_state=1) — T folded into B per (...) convention
        ...
        assert torch.abs(result.squeeze() - 1.0) < 0.05, (
